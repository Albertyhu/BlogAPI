...
const { findDuplicateCategory } = require("../util/dataHooks.js");
const he = require("he");
...
exports.CreateCategory = [
    ...
    async (req, res) => {
        ...
        var duplicateError = findDuplicateCategory(name); 
        ...
        try {
            ...
            var obj = {
                ...
                description: description.trim() ? he.decode(descrioption.trim()) : "", 
                tag, 
